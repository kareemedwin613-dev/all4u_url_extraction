-- Permanently delete Application creation batches and their cancelled Applications.
...
revoke all on function public.bulk_delete_application_batches_v316(uuid[])
  from public, anon;
grant execute on function public.bulk_delete_application_batches_v316(uuid[])
  to authenticated;
