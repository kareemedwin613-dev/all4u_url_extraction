-- Applier Overview: per resume-profile workload (total / applied / pending).
...
comment on function public.get_applier_resume_profile_workload_v31(timestamptz, timestamptz) is
  'Applier-only Overview workload by mapped Resume profile: total, applied, and pending Applications.';
