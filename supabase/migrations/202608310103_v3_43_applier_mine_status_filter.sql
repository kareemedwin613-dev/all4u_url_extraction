-- Extension My Applications: Appliers see and filter only core workflow statuses.
...
comment on function public.list_my_applications_v20(text, text, integer, uuid) is
  'Applier My Applications list limited to Assigned/In Progress/Blocked/Applied with matching status filters.';
