  ...
  begin
    with raw as (
      ...
      select deduplicated.*,
        ...
        case
          ...
          else public.application_match_eligibility(deduplicated.job_id, deduplicated.resume_id)->>'exclusionCode'
    ...
    select v_batch.id,
      ...
      case
        ...
        when validated.exclusion_code is not null then public.application_match_eligibility(validated.job_id,validated.resume_id)->>'exclusionReason'
