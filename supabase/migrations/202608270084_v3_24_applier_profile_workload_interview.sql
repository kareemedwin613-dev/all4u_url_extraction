-- Profile workload: include Interview (INTERVIEW_SCHEDULED) counts.
...
comment on function public.get_applier_resume_profile_workload_v31(timestamptz, timestamptz) is
  'Overview workload by Resume profile (Total/Applied/Pending/Blocked/Interview); own for Appliers, all for Admins.';
