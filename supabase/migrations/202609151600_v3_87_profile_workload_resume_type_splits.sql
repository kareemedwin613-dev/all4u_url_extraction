-- Profile workload: include tailored / non-tailored Applied splits (same idea as Activity Overview).
...
comment on function public.get_applier_resume_profile_workload_v31(timestamptz, timestamptz) is
  'Overview workload by Resume profile for Applications assigned to the mapped Applier; includes tailored/non-tailored Applied splits.';
