-- Applier Productivity: expose Interviews count (status = INTERVIEW_SCHEDULED).
...
comment on function public.get_business_overview_v31(timestamptz, timestamptz) is
  'Business overview with Applier productivity, including Interviews (INTERVIEW_SCHEDULED) counts.';
