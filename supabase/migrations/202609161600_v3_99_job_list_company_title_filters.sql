-- v3.99: Separate company and job-title filters on the Job Description list.

drop function if exists public.list_job_descriptions_v396(
  text, uuid, text, text, text, uuid, timestamptz, timestamptz, text, integer, integer, text
);
