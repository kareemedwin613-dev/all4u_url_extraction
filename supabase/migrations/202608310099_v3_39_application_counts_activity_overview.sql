-- Activity Overview: expose mutually exclusive status buckets for applications created in the period.
...
begin
  ...
  select jsonb_build_object(
    ...
    'other_status', count(*) filter (where status in ('UNASSIGNED', 'CANCELLED')),
