-- Surface screenshot review feedback on Application list pages (dashboard + applier mine already has it).
...
comment on function public.list_applications_v07(text, uuid, text, text, text, text, uuid, text, text, uuid, text, text, text, integer, integer) is
  'Application list page; includes screenshot_feedback for list-level review indicators.';
