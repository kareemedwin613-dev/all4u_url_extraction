# Resume JD Capture and Operations Platform v1.8
...
Apply all migrations in filename order. The latest migration is `supabase/migrations/202608030046_v1_8_tailored_resume_templates.sql`.
