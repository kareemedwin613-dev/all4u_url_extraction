...
- `POST /api/v1/application-batches/bulk-delete` permanently deletes selected batches when every linked Application is cancelled. Processing batches and batches with active Applications are rejected.
