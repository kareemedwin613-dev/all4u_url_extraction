...
- `POST /api/v1/applications/bulk-assignment`
...
Applying Managers and Admins may create, assign, bulk assign, preview, bulk create, and read batch administration records. Assigned Appliers may use the progress and screenshot routes; the existing database functions re-check assignment and allowed fields. Request DTOs enforce UUIDs, enums, URL/date formats, text limits, the 100-JD preview limit, 500-Application assignment limit, and 2,000-pair creation limit.
