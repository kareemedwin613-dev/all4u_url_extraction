...
import{TAILORED_RESUME_TEMPLATE_KEYS,type TailoredResumeTemplateKey}from"./tailored-resume-templates.js";
import{TAILORED_SKILL_GROUP_NAMES,type TailoredSkillGroupName}from"./tailored-skill-groups.js";
export const ROLE_CODES=["APPLIER","APPLYING_MANAGER","DEVELOPER","DEVELOPMENT_MANAGER","JD_FINDER","ADMIN"];
export class UserListQueryDto{@IsOptional()@IsString()@MaxLength(100)search="";@IsOptional()@IsIn(["ACTIVE","INACTIVE"])status?:string;@IsOptional()@IsIn([...ROLE_CODES,"NONE"])roleCode?:string;@IsOptional()@IsIn(["name_asc","name_desc","email_asc","email_desc","status_asc","status_desc","roles_asc","roles_desc","created_asc","created_desc"])sort="name_asc";@IsOptional()@Type(()=>Number)@IsInt()@Min(1)page=1;@IsOptional()@Type(()=>Number)@IsInt()@IsIn([25,50,100])pageSize=25;}
