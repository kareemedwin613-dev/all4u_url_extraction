...
before(async () => {
  const module = await Test.createTestingModule({ imports:[AppModule] })
    ...
    .overrideProvider(TailoringService).useValue({create:async()=>[{status:"created",resumeId:"resume-1"}],list:async()=>[{id:"tailoring-1"}],templates:()=>[{key:"CLASSIC_V1",name:"Classic",description:"Traditional"}],selectTemplate:async()=>({renderTemplateKey:"CLASSIC_V1"}),selectFormat:async(_user:any,_id:string,body:any)=>({renderFormat:body.renderFormat}),requestApplication:async(_user:any,applicationId:string)=>({id:"123e4567-e89b-42d3-a456-426614174000",applicationId,status:"PENDING"}),input:async()=>({jobId:"123e4567-e89b-42d3-a456-426614174000",input:{contractVersion:"1.2"}}),preview:async()=>({id:"123e4567-e89b-42d3-a456-426614174000",status:"NEEDS_REVIEW"}),ticket:async()=>({ticketId:"223e4567-e89b-42d3-a456-426614174000",jobId:"123e4567-e89b-42d3-a456-426614174000",ticket:`trt_${"a".repeat(43)}`,expiresAt:"2026-08-03T12:10:00Z"}),review:async()=>({id:"123e4567-e89b-42d3-a456-426614174000",status:"APPROVED"}),materialize:async()=>({jobId:"123e4567-e89b-42d3-a456-426614174000",applicationId:"223e4567-e89b-42d3-a456-426614174000",status:"COMPLETED",tailoredResumeId:"323e4567-e89b-42d3-a456-426614174000",tailoredResumeNumber:42,renderFormat:"PDF",alreadyMaterialized:false}),reviews:async()=>[{id:"review-1",action:"APPROVE"}],detail:async()=>({id:"123e4567-e89b-42d3-a456-426614174000",status:"NEEDS_REVIEW"}),cancel:async()=>({id:"tailoring-1",status:"CANCELLED"}),fileUrl:async()=>({signedUrl:"https://storage.example/queue",expiresInSeconds:90})})
