...
- `MATCHING_CODEX_SERVICE_TIER` defaults to `default`, matching the standard-processing defaults for tailoring and JD review; `auto` and `fast` remain explicit options, subject to account/model support.
