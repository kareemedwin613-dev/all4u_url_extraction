...
const manifest=JSON.parse(await readFile(resolve(dist,"manifest.json"),"utf8"));if(manifest.version!=="0.8.9")throw new Error("Built manifest must be version 0.8.9");
