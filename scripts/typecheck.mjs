...
await build({entryPoints:["extension/background/service-worker.js","extension/sidepanel/main.jsx"],bundle:true,write:false,outdir:".typecheck/extension",platform:"browser",format:"esm",target:"chrome114",jsx:"automatic",logLevel:"warning"});
