...
const root=resolve(".");
const roots=["dashboard/src","dashboard/tests","extension","scripts","tests","apps/matching-worker/src","apps/matching-worker/test","apps/jd-review-worker/src","apps/jd-review-worker/test"];
const files=[];
