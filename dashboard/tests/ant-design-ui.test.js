...
test("authenticated shell shows the saved profile name with email fallback",async()=>{const app=await read("../src/App.jsx");assert.match(app,/access\?\.fullName/);assert.match(app,/profileName\|\|access\?\.email/);});
