...
test("rejects invalid ids and unknown routes",()=>{assert.equal(parseRoute("#/applications/nope").name,"invalid-id");assert.equal(parseRoute("#/jobs/nope").name,"invalid-id");assert.equal(parseRoute("#/unknown").name,"not-found");});
