...
const ROLE_CAPABILITIES = Object.freeze({
  [ROLE_CODES.APPLIER]: [CAPABILITIES.PROFILE_VIEW_SELF, CAPABILITIES.BUSINESS_DATA_READ, CAPABILITIES.APPLICATION_VIEW],
  [ROLE_CODES.APPLYING_MANAGER]: [CAPABILITIES.PROFILE_VIEW_SELF, CAPABILITIES.BUSINESS_DATA_READ, CAPABILITIES.EXTENSION_BUSINESS_WRITE, CAPABILITIES.APPLICATION_VIEW, CAPABILITIES.APPLICATION_MANAGE, CAPABILITIES.APPLICATION_BULK_MANAGE, CAPABILITIES.USER_DIRECTORY_READ],
  [ROLE_CODES.DEVELOPER]: [CAPABILITIES.PROFILE_VIEW_SELF],
  [ROLE_CODES.DEVELOPMENT_MANAGER]: [CAPABILITIES.PROFILE_VIEW_SELF],
  [ROLE_CODES.JD_FINDER]: [CAPABILITIES.PROFILE_VIEW_SELF, CAPABILITIES.EXTENSION_BUSINESS_WRITE],
