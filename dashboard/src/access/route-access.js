...
export const ROUTE_CAPABILITIES = Object.freeze({
  ...
  "tailoring-prompts": CAPABILITIES.APPLICATION_MANAGE,
  "tailoring-job-detail": CAPABILITIES.APPLICATION_MANAGE,
  "tailoring-batches": CAPABILITIES.APPLICATION_MANAGE,
  "jd-review-batches": CAPABILITIES.APPLICATION_MANAGE,
  "jd-review-batch-detail": CAPABILITIES.APPLICATION_MANAGE,
  "tailoring-batch-detail": CAPABILITIES.APPLICATION_MANAGE,
...
export const NAVIGATION = Object.freeze([
  ...
  {name: "tailoring-prompts", label: "Tailoring Prompts", href: "#/tailoring-prompts", capability: CAPABILITIES.APPLICATION_MANAGE},
  ...
  {name: "jd-review-batches", label: "JD Review Batches", href: "#/jd-review-batches", capability: CAPABILITIES.APPLICATION_MANAGE},
