import {JOB_PAGE_SIZES,MIME_TYPES,PAGE_SIZES,SEARCH_MAX,SENIORITIES,STATUSES} from "./constants.js";
...
export function validateSignUp({email,password,fullName,confirmPassword}={}){
  const errors={},name=String(fullName||"").trim(),pass=String(password||"");
  if(!name)errors.fullName="Enter your full name.";
  else if(name.length>200)errors.fullName="Full name must be at most 200 characters.";
...
export const normalizeJobPageSize=value=>allowed(Number(value),JOB_PAGE_SIZES,25);
